 ...
 * 
 * <pre>
 * var olympicsApp = angular.module('olympicsApp', []);
 * olympicsApp.run(function($templateCache) {
 ...
 *    angular.module('olympicsApp', []).config(function($sceDelegateProvider) {
...
<file name="index.html">
  <div ng-controller="olympicsAppController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("olympicsAppController", function olympicsAppController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('olympicsAppWithSceDisabledolympicsApp', []).config(function($sceProvider) {
